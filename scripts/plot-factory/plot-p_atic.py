...
def myplot(frame, fig):
    ...
    # plot.interfaces(frame,ax1)
    plot.p_atic(2, frame,ax1)
    plot.nematic(frame,ax1)

    plot.cells(frame,ax2)
    # plot.interfaces(frame,ax2)
    plot.p_atic(3, frame,ax2)

    plot.cells(frame,ax3)
    # plot.interfaces(frame,ax3)
    plot.p_atic(4, frame,ax3)

    plot.cells(frame,ax4)
    # plot.interfaces(frame,ax4)
    plot.p_atic(6, frame,ax4)
