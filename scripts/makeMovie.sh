...
mv 'start.conf' 'initial_conf.dat'
mv 'equilibrated_conf.dat' 'start.conf'
FILENAME='start.conf'
/home/p/pinto/Phase_Field/RheoCell/build/bin/analyser input
/home/p/pinto/PythonPackages/bin/python3 /home/p/pinto/Phase_Field/RheoCell/scripts/velocityField.py "test.top" $FILENAME "1"
