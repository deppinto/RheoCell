...
class archive:
    ...
    def __init__(self, path):
        ...
        # self._nframes = int((self.nsteps-self.nstart)/step)
        self._nframes = 0
    ...
    def get_value(self, v, t):
        ...
        if t == 'double' or t == 'float':
            ...
            return np.array([self.get_value(i, t[6:-1]) for i in v], dtype="object")
        else:
    ...
    def read_frame(self, frame):
        ...
        # dat = self.extract_and_read('frame' + str(self.nstart+frame*step))
        # convert to dict
