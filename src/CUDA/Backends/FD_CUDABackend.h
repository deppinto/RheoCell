#ifndef FD_CUDABACKEND_H_
#define FD_CUDABACKEND_H_

#include <cuda.h>
#include <cuda_runtime_api.h>

#include "CUDABaseBackend.h"
#include "../../Backends/FDBackend.h"
...
/**
 * @brief Manages a FD simulation on GPU with CUDA.
 */
class FD_CUDABackend: public FDBackend, public CUDABaseBackend{
protected:
	bool _use_edge;
