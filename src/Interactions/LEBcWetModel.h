#ifndef LEBCWETMODEL_H_
#define LEBCWETMODEL_H_
...
class LEBcWetModel: public BaseInteraction {
protected:
...
public:
	...
	number get_velocity_x(BaseField *p, int q){return vec_v_x[q+field_start_index[p->index]] + shear_rate * (((double)p->map_sub_to_box_y[q] + 0.5) - 0.5 * (double)box->getYsize());}
