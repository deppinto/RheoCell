#ifndef THERMODYNAMICSTRESSFIELD_H_
#define THERMODYNAMICSTRESSFIELD_H_
...
class ThermodynamicStressField: public BaseObservable {
protected:
	int only_type;
	...
	std::vector<number> f_field_ChemPot_2;
	...
	std::vector<number> f_field_coarse_ChemPot_2;
...
public:
	ThermodynamicStressField();
	virtual ~ThermodynamicStressField();
...
#endif /* THERMODYNAMICSTRESSFIELD_H_ */
